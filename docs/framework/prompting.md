...
- **Chat with your agent:** You may use Vietnamese (or another language) when talking to the assistant; the assistant should follow your language in conversation while keeping **repo artifacts** (files under `docs/`, `templates/`, `docs/skills/`, `prompts/`, `reports/` when shared publicly) aligned with English-first unless you ask otherwise.
