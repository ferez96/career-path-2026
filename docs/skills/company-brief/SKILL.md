...
description: >-
  ...
  brief saved under data/reports/briefs with sanitization.
---
...
- **Reference weights** (adjust as needed): `docs/framework/fit-weights.md` — distributed & execution, system design, ownership & cross-team delivery, AI in production (if JD/team), domain, seniority, practical constraints.
...
**Output:** Markdown ready to save; if under `data/reports/briefs/`, **sanitize** per project policy (no PII, no sensitive contract detail).
