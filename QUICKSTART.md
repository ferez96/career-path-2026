...
| Sanitized JD analysis | `data/reports/benchmarks/` |
| Sanitized briefs | `data/reports/briefs/` |
| Sensitive / full detail | `data/reports/{pipeline,roles,companies,strategy,sessions}/` |
