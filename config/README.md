...
- `context_manifest.yaml`: ordered list of files to load for agents (token budgets, visibility). Add entries when you have new **tracked, sanitized** artifacts (includes opportunity templates/prompts; see `CURSOR.md` Opportunity Tracking).
