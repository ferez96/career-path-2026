...
**Company brief (đã làm giàu từ `data/raw`):** [alias-a_company-brief.md](../company-brief/alias-a_company-brief.md) — tổng hợp từ [data/raw/alias-a-brief-chatgpt.md](../../data/raw/alias-a-brief-chatgpt.md).
